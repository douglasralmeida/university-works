...
CREATE TABLE `pessoas` (
  ...
  `localnascimento` varchar(64) DEFAULT NULL,
  `pais` int(10) unsigned DEFAULT NULL,
  `foto` mediumblob,
  PRIMARY KEY (`idpessoa`,`nomenascimento`,`nomeartistico`),
  UNIQUE KEY `iddiretor_UNIQUE` (`idpessoa`),
  KEY `fk_pessoas_paises_idx` (`pais`),
  CONSTRAINT `fk_pessoas_paises` FOREIGN KEY (`pais`) REFERENCES `paises` (`idpais`) ON DELETE NO ACTION ON UPDATE NO ACTION
